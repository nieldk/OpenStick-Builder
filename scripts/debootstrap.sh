...
debootstrap --foreign --arch arm64 \
    ...
    ${RELEASE} ${CHROOT} http://mirrors.ustc.edu.cn/debian
...
# install kernel
# http://mirror.postmarketos.org/postmarketos/v24.06/aarch64/linux-postmarketos-qcom-msm8916-6.6-r5.apk
wget -O - https://mirror.math.princeton.edu/pub/postmarketos/master/aarch64/linux-postmarketos-qcom-msm8916-6.12.1-r2.apk \
